...
Command spec: `syndicates/blog-publishing/commands/finalize.md`
...
Resolve to the full path. If the caper is under `games/emperors-new-code/capers/`, the target is `<caper-path>/artefacts/draft.md`.
