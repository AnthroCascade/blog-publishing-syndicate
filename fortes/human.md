...
```markdown
# Human forte evaluation — [caper slug] pass [N]

## Draft read
[ ] I have read the current draft in full

## Findings

### Finding 1
**Location:** Para [N] / Section [name]
**Quote:** "[exact text]"
**Source:** observation | context | taste
**Finding:** [what's wrong or what's working]
