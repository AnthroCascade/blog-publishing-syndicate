...
Absence of AI tells. The reader never thinks "a machine wrote this."
...
Detection, not correction. Flag with exact quotes. Do not rewrite.
...
- **IMPORTANT: "Clean" is a high bar. Surface-clean text with no consciousness behind it is slop. A text that passes the kill list but fails the costly cognition test is NOT clean.**

## Deterministic execution

*TODO: When orchestration exists, mechanical patterns (kill list items) become grep/lint patterns. Saves AI attention for judgment calls (structure tells, tone tells). The forte specifies what to detect in natural language; the tooling translates to deterministic patterns.*
