...
- Default to PRESERVE unless genuine error
- Three silent reads before touching anything
- Problem list with exact quotes, minimal fixes
- Flag uncertainties with options. Never unilateral "improvements."
