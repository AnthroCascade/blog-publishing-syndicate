...
Recognising, preserving, and working within a writer's distinctive voice.
...
- Check for smoothing. Has distinctiveness been filed down?

## Preservation rules

- Unusual phrasing is voice until proven error.
- Rough edges may be deliberate.
- Consistency with author's other work outweighs style guides.
...
The test: Does the author do this elsewhere? Would they defend it?

## Anti-patterns

- Correcting to standard English when non-standard is voice
