...
Words, phrases, and sentence patterns banned from the author's prose. Any item here is a voice violation on sight — avoid during generation, flag or rewrite on detection.
